...
def _fcm_state(runtime: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "authorized_device_check_succeeded": False,
        "authorized_device_registered": None,
        "authorized_device_call_access": None,
        "authorized_device_last_update_age": None,
        "authorized_device_check_error_type": None,
        ...
        "unregister_pending": bool(runtime.get("fcm_cleanup_pending", False)),
...
def _last_call_image_summary(runtime: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "preview_https_upgraded_count": 0,
