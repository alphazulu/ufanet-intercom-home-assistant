...
### Отдельные UCAMS-камеры (draft PR #17)
...
Текущая draft-ветка live-проверена 15 сентября 2026 года: обнаружение без дубля домофонной камеры, live-видео, снимки, переходы и управление архивом, motion/timeline, MP4 export/library, обновления Lovelace и сохранение состояния после полного рестарта Home Assistant прошли без замечаний. Это подтверждение относится к протестированному аккаунту и пока не входит в опубликованный релиз v0.31.0.
