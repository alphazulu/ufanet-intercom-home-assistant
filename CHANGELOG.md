...
- Added a **КЛЮЧИ / KEYS** Lovelace tab as separate packaged frontend extensions. It shows key name, creation time, selected-key passage history, the same-device enrollment control, and backend-verified rename. Provider IDs, `external_id`, guessed physical-key numbers, and delete actions are not rendered.
