...
- Updated EN/RU user documentation, notification guide, physical-key reference, FCM reference, API verification matrix, data models, security guidance, contribution guidance and publishing checklist to preserve evidence labels, record the negative printed-number test, document live-confirmed rename/eventual consistency, record the notification cross-device live-test waiver, and retain only the remaining new-key enrollment live-validation gates.
