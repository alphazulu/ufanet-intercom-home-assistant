...
- This work remains **validation-only**: do not tag or publish a release until the active combined-validation PR's remaining notification cross-device and physical-key enrollment/FCM gates are completed or explicitly reviewed/waived.
