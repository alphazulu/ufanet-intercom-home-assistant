...
> The v0.32.0 candidate keeps the `motion_alarm` contract and evidence status,
> while extending the same privacy-minimized production model to standalone
> cameras with isolated cursor storage.
